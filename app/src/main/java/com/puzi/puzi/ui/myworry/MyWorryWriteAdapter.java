...
public class MyWorryWriteAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(v == null) {
			switch(viewType) {
				case NORMAL:
					v = inflater.inflate(R.layout.item_myworry_write_price, null);
					break;

				case SELECTED:
					v = inflater.inflate(R.layout.item_myworry_write_price_selected, null);
					break;
			}
	...
	public class ViewHolder {
		...
		@BindView(R.id.tv_item_myworry_write_title) public TextView tvtitle;
		@BindView(R.id.tv_item_myworry_write_price) public TextView tvPrice;
