...
public class CouponListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(v == null) {
			switch(viewType) {
				case VIEW_COUPON:
					v = inflater.inflate(kr.puzi.puzi.R.layout.item_coupon_child, null);
					viewHolder = new ViewHolder(v);
					v.setTag(viewHolder);
					break;

				case VIEW_EMPTY:
					v = inflater.inflate(kr.puzi.puzi.R.layout.item_list_empty_coupon, null);
					break;
	...
	public class ViewHolder {
		...
		@BindView(kr.puzi.puzi.R.id.tv_coupon_name)
		public TextView tvTitle;
		@BindView(kr.puzi.puzi.R.id.tv_coupon_price)
		public TextView tvPrice;
		@BindView(kr.puzi.puzi.R.id.tv_coupon_date)
		public TextView tvDate;
		@BindView(kr.puzi.puzi.R.id.btn_coupon)
