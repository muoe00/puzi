...
public class CompanyChannelAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(v == null) {
			switch(viewType) {
				case VIEW_CHANNEL:
					v = inflater.inflate(kr.puzi.puzi.R.layout.item_channel_list_channel_in_company, null);
					viewHolder = new ViewHolder(v);
					v.setTag(viewHolder);
					break;

				case VIEW_EMPTY:
					v = inflater.inflate(kr.puzi.puzi.R.layout.item_list_empty_channel, null);
					break;
			...
			case VIEW_CHANNEL:
				...
				if(channelList.size() > 1) {
					...
					UIUtils.setEvaluateStarScoreImage(secondChannel.getAverageScore(), viewHolder.ivStar21, viewHolder.ivStar22, viewHolder.ivStar23,
						viewHolder.ivStar24, viewHolder.ivStar25, kr.puzi.puzi.R.drawable.star, kr.puzi.puzi.R.drawable.star_copy_4);
				}
				break;
		}
	...
	public class ViewHolder {
		...
		@BindView(kr.puzi.puzi.R.id.ibtn_item_channel_image_2) public SelectableRoundedImageView ibtnImage2;
		@BindView(kr.puzi.puzi.R.id.tv_item_channel_title_1) public Button btnTitle1;
		@BindView(kr.puzi.puzi.R.id.tv_item_channel_title_2) public Button btnTitle2;
		@BindView(kr.puzi.puzi.R.id.tv_item_channel_score_1) public TextView tvScore1;
		@BindView(kr.puzi.puzi.R.id.tv_item_channel_score_2) public TextView tvScore2;
		...
		@BindView(kr.puzi.puzi.R.id.iv_item_channel_company_star2_1) public ImageView ivStar21;
		@BindView(kr.puzi.puzi.R.id.iv_item_channel_company_star2_2) public ImageView ivStar22;
		@BindView(kr.puzi.puzi.R.id.iv_item_channel_company_star2_3) public ImageView ivStar23;
		@BindView(kr.puzi.puzi.R.id.iv_item_channel_company_star2_4) public ImageView ivStar24;
		@BindView(kr.puzi.puzi.R.id.iv_item_channel_company_star2_5) public ImageView ivStar25;
