...
public class EditorsPageAdapter extends BaseAdapter {
		...
		if(v == null) {
			switch(viewType) {
				case VIEW_EDITORS_PAGE:
					v = inflater.inflate(kr.puzi.puzi.R.layout.item_channel_detail_editors_page, null);
	...
	public class ViewHolder {
		@BindView(kr.puzi.puzi.R.id.iv_item_channel_detail_editors_page_image) public SelectableRoundedImageView ivImage;
		@BindView(kr.puzi.puzi.R.id.tv_item_channel_detail_editors_page_title) public TextView tvTitle;
		@BindView(kr.puzi.puzi.R.id.tv_item_channel_detail_editors_page_name) public TextView tvName;
