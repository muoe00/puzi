package kr.puzi.puzi.ui.channel.reply;
...
public class ReplyListAdapter extends BaseAdapter {
		...
		if(v == null) {
			switch(viewType) {
				case VIEW_CHANNEL_REPLY:
					v = inflater.inflate(kr.puzi.puzi.R.layout.item_channel_detail_reply, null);
					viewHolder = new ViewHolder(v);
					v.setTag(viewHolder);
					break;

				case VIEW_EMPTY:
					v = inflater.inflate(kr.puzi.puzi.R.layout.item_list_empty_reply, null);
					break;
	...
	private void recommendUI(ViewHolder viewHolder, ChannelReplyVO channelReplyVO, boolean recommend, boolean on) {
		if(recommend) {
			if(on) {
				viewHolder.ivRecommend.setImageResource(kr.puzi.puzi.R.drawable.thumbs_up_copy);
				viewHolder.tvRecommend.setTextColor(Color.parseColor("#ff2470"));
				viewHolder.btnRecommend.setBackgroundResource(kr.puzi.puzi.R.drawable.button_reply_on);
				viewHolder.btnReverse.setBackgroundResource(kr.puzi.puzi.R.drawable.button_reply_off);
				viewHolder.btnRecommend.setEnabled(false);
				viewHolder.btnReverse.setEnabled(false);
			} else {
				viewHolder.ivRecommend.setImageResource(kr.puzi.puzi.R.drawable.thumbs_up);
				viewHolder.tvRecommend.setTextColor(Color.parseColor("#9b9b9b"));
				viewHolder.btnRecommend.setBackgroundResource(kr.puzi.puzi.R.drawable.button_reply_off);
				viewHolder.btnReverse.setBackgroundResource(kr.puzi.puzi.R.drawable.button_reply_off);
			...
			if(on) {
				viewHolder.ivReverse.setImageResource(kr.puzi.puzi.R.drawable.thumbs_down);
				viewHolder.tvReverse.setTextColor(Color.parseColor("#ff2470"));
				viewHolder.btnRecommend.setBackgroundResource(kr.puzi.puzi.R.drawable.button_reply_off);
				viewHolder.btnReverse.setBackgroundResource(kr.puzi.puzi.R.drawable.button_reply_on);
				viewHolder.btnReverse.setEnabled(false);
				viewHolder.btnRecommend.setEnabled(false);
			} else {
				viewHolder.ivReverse.setImageResource(kr.puzi.puzi.R.drawable.thumbs_down_copy);
	...
	public class ViewHolder {
		@BindView(kr.puzi.puzi.R.id.tv_channel_detail_reply_id) public TextView tvReplyId;
		@BindView(kr.puzi.puzi.R.id.tv_channel_detail_reply_comment) public TextView tvReplyComment;
		@BindView(kr.puzi.puzi.R.id.iv_channel_detail_reply_recommend) public ImageView ivRecommend;
		@BindView(kr.puzi.puzi.R.id.tv_channel_detail_reply_recommend) public TextView tvRecommend;
		@BindView(kr.puzi.puzi.R.id.btn_channel_detail_reply_recommend) public Button btnRecommend;
		@BindView(kr.puzi.puzi.R.id.iv_channel_detail_reply_reverse) public ImageView ivReverse;
		@BindView(kr.puzi.puzi.R.id.tv_channel_detail_reply_reverse) public TextView tvReverse;
		@BindView(kr.puzi.puzi.R.id.btn_channel_detail_reply_reverse) public Button btnReverse;
