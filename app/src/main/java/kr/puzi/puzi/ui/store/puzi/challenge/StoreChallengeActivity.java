...
public class StoreChallengeActivity extends BaseFragmentActivity implements AdapterView.OnItemClickListener {
	...
	@BindView(kr.puzi.puzi.R.id.gv_store_challenge)
	GridView gvChallenge;
	@BindView(kr.puzi.puzi.R.id.sv_store_challenge)
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(kr.puzi.puzi.R.layout.activity_store_challenge);
