...
public class BlockTimeFragment extends BaseFragment {
	...
	@BindView(kr.puzi.puzi.R.id.sp_setting_block_time_start)
	Spinner spStart;
	@BindView(kr.puzi.puzi.R.id.sp_setting_block_time_end)
	Spinner spEnd;
	@BindView(kr.puzi.puzi.R.id.lv_setting_block_time)
	ListView lvBlockTime;
	@BindView(kr.puzi.puzi.R.id.sv_setting_block_time)
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View view = inflater.inflate(kr.puzi.puzi.R.layout.fragment_setting_block_time, container, false);
	...
	private void initComponent() {
		adapter = new BlockTimeAdapter(getActivity(), kr.puzi.puzi.R.layout.item_block_time, lvBlockTime, svBlockTime, new CustomPagingAdapter.ListHandler(){
			@Override
			public void getList() {
				getBlockedTimeList();
			}
		...
		spStart.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onNothingSelected(AdapterView<?> parent) {
				parent.setBackgroundResource(kr.puzi.puzi.R.drawable.button_block_time_off);
			}
		});
	...
	@OnClick(kr.puzi.puzi.R.id.ibtn_setting_block_time_add)
